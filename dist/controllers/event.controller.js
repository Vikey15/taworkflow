...
tslib_1.__decorate([
    (0, rest_1.post)('/events'),
    (0, rest_1.response)(200, {
        description: 'Event model instance',
        content: { 'application/json': { schema: (0, rest_1.getModelSchemaRef)(models_1.Event) } },
    }),
    tslib_1.__param(0, (0, rest_1.requestBody)({
        content: {
            'application/json': {
                schema: (0, rest_1.getModelSchemaRef)(models_1.Event, {
                    title: 'NewEvent',
                }),
            },
        },
    ...
    tslib_1.__metadata("design:paramtypes", [models_1.Event]),
    tslib_1.__metadata("design:returntype", Promise)
], EventController.prototype, "create", null);
tslib_1.__decorate([
    (0, rest_1.get)('/events/count'),
    (0, rest_1.response)(200, {
    ...
    (0, rest_1.response)(200, {
        ...
        content: {
            'application/json': {
                schema: {
                    type: 'array',
                    items: (0, rest_1.getModelSchemaRef)(models_1.Event, { includeRelations: true }),
                },
            },
        },
    }),
...
tslib_1.__decorate([
    ...
    tslib_1.__param(0, (0, rest_1.requestBody)({
        content: {
            'application/json': {
                schema: (0, rest_1.getModelSchemaRef)(models_1.Event, { partial: true }),
            },
        },
    })),
...
tslib_1.__decorate([
    (0, rest_1.get)('/events/{id}'),
    (0, rest_1.response)(200, {
        description: 'Event model instance',
        content: {
            'application/json': {
                schema: (0, rest_1.getModelSchemaRef)(models_1.Event, { includeRelations: true }),
            },
        },
    }),
...
exports.EventController = EventController = tslib_1.__decorate([
    tslib_1.__param(0, (0, repository_1.repository)(repositories_1.EventRepository)),
