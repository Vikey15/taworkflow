...
exports.UserTaskRepository = void 0;
const tslib_1 = require("tslib");
const core_1 = require("@loopback/core");
const repository_1 = require("@loopback/repository");
const models_1 = require("../models");
let UserTaskRepository = class UserTaskRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.UserTask, dataSource);
    }
};
exports.UserTaskRepository = UserTaskRepository;
exports.UserTaskRepository = UserTaskRepository = tslib_1.__decorate([
