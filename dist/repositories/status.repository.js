...
let StatusRepository = class StatusRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Status, dataSource);
    }
};
exports.StatusRepository = StatusRepository;
exports.StatusRepository = StatusRepository = tslib_1.__decorate([
